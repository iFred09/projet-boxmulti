//
// RemoteClient Java pour communiquer avec le Serveur C++
...
public class RemoteClient
{
  ...
  public static void main(String argv[]) {
    ...
    try {
      ...
      System.err.println("RemoteClient: Couldn't connect to "+host+":"+port);
      System.exit(1);
    }
    
    System.out.println("RemoteClient connected to "+host+":"+port);
    ...
    while (true) {
      ...
      try {
        ...
        System.err.println("RemoteClient: IO error");
        return;
      }
    }
  }
  ...
  public RemoteClient(String host, int port) throws UnknownHostException, IOException {
    try {
      ...
      System.err.println("RemoteClient: Couldn't find host "+host+":"+port);
      throw e;
    }
    catch (java.io.IOException e) {
      System.err.println("RemoteClient: Couldn't reach host "+host+":"+port);
      throw e;
    }
    ...
    try {
      ...
      System.err.println("RemoteClient: Couldn't open input or output streams");
      throw e;
    }
  }
  ...
  public String send(String request) {
    ...
    try {
      ...
      System.err.println("RemoteClient: Couldn't send message: " + e);
      return null;
    }
    ...
    try {
      ...
      System.err.println("RemoteClient: Couldn't receive message: " + e);
      return null;
    }
  }
}
